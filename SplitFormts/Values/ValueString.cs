...
namespace SplitFormts.Values
{
   ...
   　internal sealed class ValueString
        : IValueObject
    {
        #region "fields"

        /// <summary>単一インスタンス。</summary>
        private static ValueString instance;

        /// <summary>単一インスタンス（日付チェック済み）</summary>
        private static ValueString dayChecked;

        #endregion

        #region "properties"

        /// <summary>文字列値インスタンスを取得する。</summary>
        public static ValueString Instance
        {
            get {
                return instance;
            }
        ...
        /// <summary>文字列値インスタンスを取得する（日付チェック済み）</summary>
        public static ValueString InstanceOfDayChecked
        {
            get {
                return dayChecked;
            }
        ...
        public ValueObjectTypeEnum ValueObjectType => ValueObjectTypeEnum.TypeString;
        ...
        static ValueString()
        {
            instance = new ValueString();
            dayChecked = new ValueString();
        }
